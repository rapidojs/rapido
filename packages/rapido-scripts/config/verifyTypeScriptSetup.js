...
const immer = require('@rapido/dev-utils/immer').produce;
const globby = require('@rapido/dev-utils/globby').sync;
...
function verifyTypeScriptSetup() {
  ...
  // Reference `@rapido/scripts` types
  if (!fs.existsSync(paths.appTypeDeclarations)) {
    fs.writeFileSync(
      paths.appTypeDeclarations,
      `/// <reference types="@rapido/scripts" />${os.EOL}`
    );
  }
}
